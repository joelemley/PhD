...
def create_inception_v4(input, nb_output=10):
...
#    from keras.utils.visualize_util import plot
    ...
    model.fit(train_set, Y_train, validation_data=(valset, Y_trainVal), batch_size=5, nb_epoch=10,shuffle=True)
    # Split the data
