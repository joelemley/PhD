...
from keras.layers.convolutional import Convolution3D, MaxPooling3D, Convolution1D, Convolution2D
...
model.add(Convolution2D(16, 3, 3, 3, input_shape=(3, 480, 640),  activation='relu'))

model.add(ConvLSTM2D(nb_filter=10,nb_col=3,nb_row=3, return_sequences=True, border_mode='same'))
